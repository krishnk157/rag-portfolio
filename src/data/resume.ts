  ...
  projects: [
    {
      ...
      highlights: [
        ...
        "Semantic search over resume chunks using 768-dimension Gemini embeddings with cosine similarity.",
        "Streaming responses powered by the Vercel AI SDK with Gemini 3.1 Flash Lite as the LLM.",
